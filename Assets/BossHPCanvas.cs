...
public class BossHPCanvas : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        controller.GetComponent<Health>().OnHit += OnHitHandler;
    }
    ...
    private void OnHitHandler(int currentHealth)
    {
        DOTweenModuleUI.DOValue(slider, currentHealth, sliderScaleTime).SetEase(Ease.OutExpo);
    }
